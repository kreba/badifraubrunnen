# Generated by the restful-authentication gem
module AuthenticatedSystem
  protected
    ...
    def login_from_session
      self.current_person = Person.find_by(id: session[:person_id]) if session[:person_id]
    end
    ...
    def login_from_cookie
      person = cookies[:auth_token] && Person.find_by(remember_token: cookies[:auth_token].value)
