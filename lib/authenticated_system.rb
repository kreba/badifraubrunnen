module AuthenticatedSystem
  protected
    ...
    def current_person=(new_person)
      ...
      @current_person = new_person ? (Person.find(new_person, :include => :roles) || false) : nil
      # TODO: why does eager loading of the roles not allow to ask is_admin? without a database request?
    end
    ...
    # behavior in case the person is not authorized to access the requested action.  
